...
folds <- list.files("results")[grep(paste0("D", c(11:13, 21:23), collapse ="|"), list.files("results"))]
...
#100 iterations, 36 scenarios run took 3.4 minutes

names(reslist) <- flz
save(reslist, file = "results/D11toD23_EM11toEM14_reslist.Rdata")

#------------------------------------------------------
#Process the results
tsres <- pull_timeseries(reslist)

save(tsres, file = "results/D11toD23_EM11toEM14_tsres.Rdata")
...
#Save the results
save(tsRE, file = "results/D11toD23_EM11toEM14_tsRE.Rdata")
